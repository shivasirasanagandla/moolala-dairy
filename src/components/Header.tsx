          ...
          {user ? (
            <div style={{ position: 'relative' }}>
              ...
              <SettingsDropdown isOpen={isSettingsOpen}>
                <SettingsItem onClick={() => handleSettingsClick('profile')}>
                  <UserCheck size={16} />
                  Profile Settings
                </SettingsItem>
                <SettingsItem onClick={() => handleSettingsClick('notifications')}>
                  <Bell size={16} />
                  Notifications
                </SettingsItem>
                <SettingsItem onClick={() => handleSettingsClick('security')}>
                  <Shield size={16} />
                  Security
                </SettingsItem>
                <SettingsItem onClick={() => handleSettingsClick('help')}>
                  <HelpCircle size={16} />
                  Help & Support
                </SettingsItem>
