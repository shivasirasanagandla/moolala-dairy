...
const DeliveryScheduler = styled(motion.div)`
  background: white;
  border-radius: 20px;
  padding: 2rem;
  margin-top: 2rem;
...
const SchedulerTitle = styled.h4`
  font-family: 'Playfair Display', serif;
  font-size: 1.3rem;
  font-weight: 600;
  color: #1e293b;
...
const TimeSlot = styled.button<{ selected: boolean }>`
  ...
  color: ${props => props.selected ? '#92400e' : '#64748b'};
  cursor: pointer;
  transition: all 0.3s ease;
  font-weight: 500;
      ...
      <Container>
        ...
        >
          ...
          <p style={{ color: '#64748b', marginBottom: '1rem' }}>
            Choose your preferred delivery time. We deliver fresh milk within 3 hours of milking.
          </p>
          <TimeSlots>
            {timeSlots.map((slot) => (
              <TimeSlot
