      ...
      <Container>
        <FooterContent>
          ...
          >
            <h3>Quick Links</h3>
            <QuickLinks>
              <QuickLink onClick={() => scrollToSection('about')}>About Us</QuickLink>
              <QuickLink onClick={() => scrollToSection('products')}>Our Products</QuickLink>
  
              <QuickLink onClick={() => scrollToSection('practices')}>Farming Practices</QuickLink>
              <QuickLink onClick={() => scrollToSection('contact')}>Contact Us</QuickLink>
            </QuickLinks>
          </FooterColumn>
